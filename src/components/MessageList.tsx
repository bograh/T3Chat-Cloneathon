                ...
                if (props.node?.tagName === "code" && language) {
                  ...
                  const CopyButton = () => {
                    ...
                    return (
                      <button
                        onClick={handleCopy}
                        className="opacity-100 group-hover:opacity-100 transition-opacity duration-200 bg-gray-800 hover:bg-gray-700 text-white p-1.5 rounded text-xs flex items-center gap-1"
                        title="Copy code"
                      >
                        {copied ? (
                          <>
